class ApartmentPaymentModel {
  constructor(payment) {
    this.user_id = payment.user_id;
    this.property_id = payment.property_id; // apartment_id
    this.unit_id = payment.unit_id;
  ...
  validate() {
    if (
      ...
      return {
        valid: false,
        message: "All apartment payment fields are required",
      };
    }
...
export default ApartmentPaymentModel;
